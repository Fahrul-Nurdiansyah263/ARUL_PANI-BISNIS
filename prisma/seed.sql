...
VALUES ('comp_sejiwa', 'Sejiwa Agency', 'sejiwa-agency', NULL, NOW());
...
VALUES 
('usr_fahrul', 'comp_sejiwa', 'Fahrul Nurdiansyah', 'fahrul@sejiwa.agency', '$2b$12$obtUdnjpuOoutEpqUGmmIu0liQVFHt.3jlg3Gx1mPker6UO0qDjkK', 'OWNER'::"Role",  NULL, 'Creative Director',  TRUE, NOW()),
('usr_rina',   'comp_sejiwa', 'Rina Kusuma',        'rina@sejiwa.agency',   '$2b$12$obtUdnjpuOoutEpqUGmmIu0liQVFHt.3jlg3Gx1mPker6UO0qDjkK', 'MEMBER'::"Role", NULL, 'Branding',           TRUE, NOW()),
('usr_budi',   'comp_sejiwa', 'Budi Santoso',       'budi@sejiwa.agency',   '$2b$12$obtUdnjpuOoutEpqUGmmIu0liQVFHt.3jlg3Gx1mPker6UO0qDjkK', 'MEMBER'::"Role", NULL, 'Content Writer',     TRUE, NOW()),
('usr_andi',   'comp_sejiwa', 'Andi Pratama',       'andi@sejiwa.agency',   '$2b$12$obtUdnjpuOoutEpqUGmmIu0liQVFHt.3jlg3Gx1mPker6UO0qDjkK', 'MEMBER'::"Role", NULL, 'Frontend Developer', TRUE, NOW()),
('usr_sari',   'comp_sejiwa', 'Sari Dewi',          'sari@sejiwa.agency',   '$2b$12$obtUdnjpuOoutEpqUGmmIu0liQVFHt.3jlg3Gx1mPker6UO0qDjkK', 'MEMBER'::"Role", NULL, 'Social Media',       TRUE, NOW()),
('usr_rizky',  'comp_sejiwa', 'Rizky Pratama',      'rizky@sejiwa.agency',  '$2b$12$obtUdnjpuOoutEpqUGmmIu0liQVFHt.3jlg3Gx1mPker6UO0qDjkK', 'MEMBER'::"Role", NULL, 'Graphic Designer',   TRUE, NOW()),
('usr_dewi',   'comp_sejiwa', 'Dewi Lestari',       'dewi@sejiwa.agency',   '$2b$12$obtUdnjpuOoutEpqUGmmIu0liQVFHt.3jlg3Gx1mPker6UO0qDjkK', 'MEMBER'::"Role", NULL, 'Copywriter',         TRUE, NOW());
...
SELECT
  ...
  END || ' #' || num.n as "title",
  'Deskripsi tiket untuk proyek Sejiwa Agency. Dibuat secara otomatis untuk data historis.' as "description",
  (
    SELECT id FROM "User"
    WHERE role = 'MEMBER'
